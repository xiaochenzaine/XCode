...
fun WorkspaceDetailPage(id: String) {
    ...
    val workspaceEnableError by vm.workspaceEnableError.collectAsStateWithLifecycle()
        ...
        HorizontalPager(
            ...
            when (page) {
                0 -> WorkspaceBasicPage(
                    ...
                    onWorkspaceEnabledChange = vm::setWorkspaceEnabled,
    ...
    workspaceEnableError?.let { message ->
        AlertDialog(
            onDismissRequest = vm::dismissWorkspaceEnableError,
            title = { Text(stringResource(R.string.workspace_detail_enable_workspace_failed)) },
            text = { Text(message) },
            confirmButton = {
                TextButton(onClick = vm::dismissWorkspaceEnableError) {
...
private fun WorkspaceBasicPage(
    ...
    onWorkspaceEnabledChange: (Boolean) -> Unit,
    onToolApprovalChange: (String, Boolean) -> Unit,
) {
    val shellStatus = workspace?.shellStatus
    val workspaceEnabled = shellStatus == WorkspaceShellStatus.READY.name
                ...
                Column(
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text(
                                text = stringResource(R.string.workspace_detail_enable_workspace),
                                style = MaterialTheme.typography.titleMedium,
                            )
                            Text(
                                text = stringResource(R.string.workspace_detail_enable_workspace_desc),
